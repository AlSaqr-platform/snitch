...
add wave -noupdate -expand -group HWPE_interface -subitemconfig {{/tb_bin/i_dut/i_snitch_cluster/i_cluster/i_snitch_hwpe_subsystem/narrow_hwpe_tcdm_resp_i[4]} -expand} /tb_bin/i_dut/i_snitch_cluster/i_cluster/i_snitch_hwpe_subsystem/narrow_hwpe_tcdm_resp_i
...
add wave -noupdate -expand -group HWPE_interface /tb_bin/i_dut/i_snitch_cluster/i_cluster/i_snitch_hwpe_subsystem/hwpe_ctrl_req_i
...
add wave -noupdate -group {snitch[0]} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/data_rsp_i}
...
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/clk_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/rst_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qtag_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qwrite_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qsigned_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qaddr_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qdata_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qsize_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qamo_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qvalid_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_qready_o}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_pdata_o}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_ptag_o}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_perror_o}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_pvalid_o}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_pready_i}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/lsu_empty_o}
add wave -noupdate -group {SNITCH[0].LSU} -expand -subitemconfig {{/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/data_req_o.q} -expand} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/data_req_o}
add wave -noupdate -group {SNITCH[0].LSU} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_lsu/data_rsp_i}
add wave -noupdate -group {SNITCH[0].GPRF} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_regfile/clk_i}
add wave -noupdate -group {SNITCH[0].GPRF} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_regfile/raddr_i}
add wave -noupdate -group {SNITCH[0].GPRF} -expand {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_regfile/rdata_o}
add wave -noupdate -group {SNITCH[0].GPRF} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_regfile/waddr_i}
add wave -noupdate -group {SNITCH[0].GPRF} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_regfile/wdata_i}
add wave -noupdate -group {SNITCH[0].GPRF} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_regfile/we_i}
add wave -noupdate -group {SNITCH[0].GPRF} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_regfile/mem}
add wave -noupdate -group {SNITCH[0].GPRF} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/i_snitch/i_snitch_regfile/we_dec}
...
add wave -noupdate -group tcdm_interconnect -subitemconfig {{/tb_bin/i_dut/i_snitch_cluster/i_cluster/i_tcdm_interconnect/rsp_o[3]} -expand} /tb_bin/i_dut/i_snitch_cluster/i_cluster/i_tcdm_interconnect/rsp_o
...
WaveRestoreCursors {{Cursor 1} {34953000 ps} 1} {{Cursor 3} {34959513 ps} 0} {{Cursor 4} {34949000 ps} 1}
...
update
WaveRestoreZoom {34950489 ps} {34968537 ps}
